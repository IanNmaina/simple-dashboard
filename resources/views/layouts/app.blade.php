...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
        ...
        <div class="w-full container mx-auto flex flex-wrap items-center mt-0 pt-3 pb-3 md:pb-0">
            ...
            <div class="w-1/2 pl-2 md:pl-0">
                <a class="text-gray-900 text-base xl:text-xl no-underline hover:no-underline font-bold" href="#">
                    <i class="fas fa-sun text-pink-600 pr-3"></i> Project management
                </a>
            </div>
            ...
            <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-white z-20" id="nav-content">
                <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
                    ...
                    <li class="mr-6 my-2 md:my-0">
                        <a href="/createProject" class="block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-900 border-b-2 border-white hover:border-pink-500">
                            <i class="fas fa-plus fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Add Project</span>
                        </a>
                    </li>
    ...
    <div x-data="{ show: false, message: '', type: '' }"
        ...
        class="fixed bottom-5 right-5 p-4 rounded-md text-white shadow-md"
        style="display: none;">
        <p x-text="message"></p>
    </div>
        ...
        <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative mb-4" role="alert">
            ...
            <span class="absolute top-0 bottom-0 right-0 px-4 py-3">
                <svg class="fill-current h-6 w-6 text-green-500" role="button" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                    <path d="M14.348 14.849a1 1 0 01-1.414 0L10 11.414l-2.936 2.936a1 1 0 01-1.414-1.414l2.936-2.936-2.936-2.936a1 1 0 011.414-1.414L10 8.586l2.936-2.936a1 1 0 111.414 1.414L11.414 10l2.936 2.936a1 1 0 010 1.414z" />
                </svg>
            </span>
        </div>
        @endif
    ...
    <script>
        ...
        // Optionally, you can make the alerts disappear after a few seconds
        setTimeout(function() {
